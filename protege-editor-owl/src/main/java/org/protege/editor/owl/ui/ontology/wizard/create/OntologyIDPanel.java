...
public class OntologyIDPanel extends AbstractWizardPanel {
    ...
    public OntologyIDPanel(OWLEditorKit editorKit) {
        super(ID, "Ontology ID", editorKit);
    }
    ...
    protected void createUI(JComponent parent) {
        ...
        ontologyIRIField = new AugmentedJTextField(OntologyPreferences.getInstance().generateURI().toString(),
                "Enter ontology IRI");
...
//        versionIRIField.setEnabled(false);
        ...
        holderPanel.add(ontologyIRIField,
                new GridBagConstraints(0, 1, 1, 1, 100, 100,
                        GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, insets, 0, 0));

        holderPanel.add(Box.createVerticalStrut(12),
                new GridBagConstraints(0, 2, 1, 1, 100, 100,
                        GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, insets, 0, 0));
...
//                new GridBagConstraints(0, 3, 1, 1, 100, 100, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 10));
        ...
        holderPanel.add(createLabel("Ontology Version IRI (Optional)"),
                new GridBagConstraints(0, 4, 1, 1, 100, 100,
                        GridBagConstraints.WEST, GridBagConstraints.NONE, versionIRIInsets, 0, 5));

        holderPanel.add(versionIRIField,
                new GridBagConstraints(0, 5, 1, 1, 100, 100,
                        GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, versionIRIInsets, 0, 0));
    ...
    public OWLOntologyID getOntologyID() {
        try {
            ...
            if (ontologyVersionIRIString.isEmpty()) {
                return new OWLOntologyID(Optional.of(ontologyIRI), Optional.empty());
            } else {
