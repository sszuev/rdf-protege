 ...
 * </p>
 */
public abstract class PageCellRenderer extends JPanel
        implements ListCellRenderer<Object>, TableCellRenderer, RendererWithInsets {
    ...
    /**
     * Given the value being rendered, returns an object that represents a key for this value.
     * Subclasses may override this method to provide an appropriate key.
     *
     * @param value The value of the cell that is being rendered, this is the object that is passed in the
     *              {@link ListCellRenderer#getListCellRendererComponent(javax.swing.JList, Object, int, boolean, boolean)}
     *              method for a {@code JList}, and
     *              {@link TableCellRenderer#getTableCellRendererComponent(javax.swing.JTable, Object, boolean, boolean, int, int)}
     *              for a {@code JTable}
     ...
     * @param hasFocus   A flag to specify whether or not the cell being rendered has the focus.
     ...
     * That component's <code>paint</code> method is then called to "render" the cell.
     * If it is necessary to compute the dimensions of a list because the list cells do not have a fixed size,
     * this method is called to generate a component on which <code>getPreferredSize</code> can be invoked.
     *
...
//        }
     ...
     * If this renderer cares about rendering the DnD drop location,
     * it should query the table directly to see if the given row and column represent the drop location:
     * <pre>
     ...
     * values of <code>false</code> to prevent selection and focus from appearing in the printed output.
     * To do other customization based on whether or not the table is being printed,
     * check the return value from {@link javax.swing.JComponent#isPaintingForPrint()}.
     *
     * @param table      the <code>JTable</code> that is asking the
     *                   renderer to draw; can be <code>null</code>
     * @param value      the value of the cell to be rendered;
     *                   it is up to the specific renderer to interpret and draw the value -
     *                   for example, if <code>value</code> is the string "true",
     *                   it could be rendered as a string or it could be rendered as a check box that is checked;
     *                   <code>null</code> is a valid value
     * @param isSelected {@code true} if the cell is to be rendered with the selection highlighted; otherwise
     *                   {@code false}
     * @param hasFocus   if {@code true}, render cell appropriately - for example, put a special border on the cell,
     ...
     */
    protected abstract void fillPage(Page page,
                                     JTable table,
                                     Object value,
                                     boolean isSelected,
                                     boolean hasFocus,
    ...
    protected abstract int getMaxAvailablePageWidth(Page page,
                                                    JTable table,
                                                    Object value,
                                                    boolean isSelected,
                                                    boolean hasFocus,
